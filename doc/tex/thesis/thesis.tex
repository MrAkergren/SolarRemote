...
\begin{document}
    ...
    \label{sec:genomforande}
        ...
        \subsection{Demonstrering och Utvärdering} % (fold)
        \label{sub:demonstrering_och_utv_rdering}
    
        % subsection demonstrering_och_utv_rdering (end)
    ...
    \label{sec:resultat}
        ...
        \paragraph{Vad styr valet av plattform för styrdosan?} % (fold)
        ...
        \paragraph{Enkel för kunderna att använda?} % (fold)
        \label{par:enk}
            Resultatet levererar en produkt som är att anses som användarvänlig när produkten sätts i förhållande till den nuvarande tillväga\-gångs\-sättet. \\
        % paragraph enk (end)
