...
\begin{document}
    ...
    \label{sec:resultat}
        Det här avsnittet avser att knyta an till frågeställningen och besvara den frågeställning som ligger till grund för arbetet. Resultatet presenteras genom en redovisning av den produkt som genomförandet har lett fram till. \\

        \noindent Valet av plattform för utveckling av produkten grundar sig i en utvärdering av olika alternativ, där den mest tillgängliga och lämpliga kandidaten valdes, nämligen en 'Raspberry Pi', se avsnitt \ref{sub:val_av_plattform}. 
        Denna plattform användes som grund till det användargränssnitt, en resistiv pekskärm framtagen till just denna plattform \cite{Ada}. 
