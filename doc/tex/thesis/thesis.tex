...
\begin{document}
    ...
    % section section_name (end)
        ...
        \label{sub:bakgrund}
            ...
            \noindent Själva panelen driv av en spänning om tolv (12) volt och dess systemdesign bygger på en PIC32; koden är skriven i C. Parans kommunicerar med enheten via USB--port och en terminalemulator. 
