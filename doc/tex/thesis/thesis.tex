...
\begin{document}
	...
	\label{sec:huvudtext}
		...
		\noindent Anledningen till att vi valde Design Science Research (DSR) framför exempelvis 'Action Reserach' (AR), vilken också är en iterativ metod och väldigt lik DSR i sitt utförande,  var att DSR strävar mot att designa och skapa artefakter vilket går väl ihop med att utveckla en handhållen fysisk enhet. \cite {designscience} \\
